...
router.post("/",(req, res)=>{
    ...
    if((req.body.username == process.env.username1 || process.env.username2 || process.env.username3) && (req.body.password == process.env.password1 || process.env.password2 || process.env.password3)){
